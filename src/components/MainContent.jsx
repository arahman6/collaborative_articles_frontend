    ...
    <Box sx={{ display: "flex", flexDirection: "column", gap: 4 }}>
      ...
      <Grid container spacing={2} columns={12}>
        <Grid size={{ xs: 12, md: 6 }}>
          <SyledCard
            variant="outlined"
            onClick={() => handleCardClick(cardData[0]._id)}
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <SyledCard
            variant="outlined"
            onClick={() => handleCardClick(cardData[1]._id)}
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <SyledCard
            variant="outlined"
            onClick={() => handleCardClick(cardData[2]._id)}
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          >
            <SyledCard
              variant="outlined"
              onClick={() => handleCardClick(cardData[3]._id)}
            ...
            <SyledCard
              variant="outlined"
              onClick={() => handleCardClick(cardData[4]._id)}
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <SyledCard
            variant="outlined"
            onClick={() => handleCardClick(cardData[5]._id)}
